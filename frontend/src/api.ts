...
export async function runPipeline(
  ...
  const config = {
    ...
    enable_market_valuation: enableMarketValuation,
    valuation_price_field_key: valuationPriceFieldKey ?? null,
    valuation_analogs_count: Math.max(1, Math.floor(topN)),
